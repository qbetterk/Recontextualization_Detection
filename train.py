...
def main():
    ...
    if "roberta" in model_args.model_name_or_path:
        ...
        model = RobertaModel.from_pretrained(model_args.model_name_or_path)
    else:
    ...
    def preprocess_function(examples):
        inputs, targets = [], []
        for i in range(len(examples[title_column_name])):
            if examples[title_column_name][i] and examples[text_column_name][i] and examples[sum_column_name][i]:
                inputs.append("title: " + examples[title_column_name][i] + " text: " + examples[text_column_name][i])
                targets.append(examples[sum_column_name][i])
